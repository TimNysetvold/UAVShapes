...
separation(1)=input1; %the separation standard this UAV attempts to maintain
...
for currentIteration=1:iterations
    ...
    %Using prefilter, this functionality is performed for each drone
    %individually, within the drone move loop.
