function dronearray = newDroneArray(numdrones, avmaxvel, stdevmaxvel, maxaccel, infringe, priority, type,stamina,xbase,ybase,pause,baselength,loiter,cruiseheight)
...
sz = size(addvector)
randomVec = random('Normal',avmaxvel,stdevmaxvel,sz)
maxvelvec=randomVec;
